...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "Below there's a list of commands that you can use.\nAlso, you know what ? Autocomplete works !!! press TAB for autocomplete.",
        ls_help: "List information about the files and folders (the current directory by default).",
        cat_help: "Read FILE(s) content and print it to the standard output (screen). (Hint: try 'cat filename' without quotes, and don't forget to press enter)",
        whoami_help: "Print the user name associated with the current effective user ID and more info.",
        date_help: "Print the system date and time.",
        help_help: "This will bring you back here (It's a trap).",
        clear_help: "Clear the terminal screen.",
        reboot_help: "Reboot the system.",
        cd_help: "Change the current working directory.",
        mv_help: "Move (rename) files.",
        rm_help: "Remove files or directories (This won't help you forget them though).",
        rmdir_help: "This removes directory only if they are already dead inside(I mean empty).",
        touch_help: "Change file timestamps. If the file doesn't exist, it's created an empty one.",
        sudo_help: "Execute a command as the superuser.",
        welcome: "Welcome aboard.\nIf you've managed to come here then you already know my name.\nSeen a terminal before ? try executing the help command (That'll help you, I won't).\n Totally confused about how to proceed ? there's a menu to help you out on the left side.",
        internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
        welcome_file_name: "welcome_message.txt",
        invalid_command_message: "<value>: command not found. Try `help` for a list of valid commands.",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "contact.txt": "Let's catchup ?\nDrop me a mail : pingme@rajat.sh",
