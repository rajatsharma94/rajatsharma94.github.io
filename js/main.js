...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        cat_help: "Read FILE(s) content and print it to the standard output (screen).\n(Hint: try 'cat filename' without quote, and don't forget to press enter)",
        ...
        welcome: "Welcome aboard.\nIf you've managed to come here then you already know my name.\nIf you have seen a terminal before, try executing the help command (That'll help you, I won't).\n If you feel confused about how to proceed, there's a menu to help you out on the left side.",
